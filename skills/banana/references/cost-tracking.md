...
```bash
# Log a generation
python3 skills/banana/scripts/cost_tracker.py log --model gemini-3.1-flash-image-preview --resolution 1K --prompt "coffee shop hero"

# View summary (total + last 7 days)
python3 skills/banana/scripts/cost_tracker.py summary

# Today's usage
python3 skills/banana/scripts/cost_tracker.py today

# Estimate before batch
python3 skills/banana/scripts/cost_tracker.py estimate --model gemini-3.1-flash-image-preview --resolution 1K --count 10

# Reset ledger
python3 skills/banana/scripts/cost_tracker.py reset --confirm
```
